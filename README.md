# Cascaron · alquimia-urbana

Este repo **no tiene codigo**. Es una direccion vieja que sigue viva.

El tablero real vive en `yodesarrollomx/alquimia-urbana` y se sirve en:
<https://yodesarrollomx.github.io/alquimia-urbana/>
...
`https://alexpueblag.github.io/alquimia-urbana/` daria 404 para siempre.
